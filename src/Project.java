...
/**
 * Multithreaded program which reads in two matrices from files and then adds
 * them together.
 * 
 * @author Aziz Ali
 *
...
public class Project {
	...
	public static void main(String[] args) throws InterruptedException, FileNotFoundException {
		...
		for (int i = 0; i < 10; i++) {
			...
			thd = new Thread(new Summation(column1, column2, sumObject));
			thd.start();
...
// This is the runnable class. It takes two columns, one from each big matrix,
...
class Summation implements Runnable {
	...
	/**
	 * Runnable method. It simply adds two elements from each matrix and places the
	 * result in matrix3. It then sends matrix3 to sumValue so it can be retrieved.
	 */
	@Override
	public void run() {
...
/**
 * This Sum class is used to retrieve the results in the main class from the
 * runnable class.
 * 
 * @author Aziz Ali
 */
